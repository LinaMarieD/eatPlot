...
```{r chpt_3_MinStand_trend}
  ...
  ## add a, then align, thann gsub a with <sup
#  construct_label(dat_bar, label_est = "est_noTrend_noComp_2011_percent", round_est = 1, label_sig_high = "sig_Trend_CompCrossDiffWhole_20112016")$label
  ...
  p_bar_1 <- plot_tablebar(
    ...
    columns_table_sig_bold = list(
      ...
      NULL,
      NULL,
      NULL, #"sig_Trend_noComp_20112016",
      NULL
    ),
  ...
  p_bar_2 <- plot_tablebar(
    ...
    columns_table_sig_bold = list(
      NULL,
      NULL,
      NULL, #"sig_Trend_noComp_20162021",
      NULL
    ),
    columns_table_sig_high = list(
      NULL,
...
```{r, eval = FALSE}
save_plot(minsta_plot_trend, filename = "../Kap3_2022_MSA_trend-v03.pdf")
```
